from sqlalchemy import create_engine, String, Float, Integer, ForeignKey, Boolean, Text, DateTime, JSON
...
engine = create_engine("sqlite:///online_restaurant.db", echo=True)
